    ...
    <div className="flex flex-col items-center text-center px-4" id="about">
      ...
      <div className="flex flex-col justify-center items-center w-full  ">
        ...
        <button
          ...
          className="bg-[#F68B1F] text-white px-10 py-3 rounded-full cursor-pointer font-medium text-sm md:text-base hover:bg-[#e17812] transition-colors duration-300 shadow-[0_4px_50px_rgba(247,148,29,0.40)] "
        >
          Book a Demo
        </button>
