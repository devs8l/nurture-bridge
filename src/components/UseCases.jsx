      ...
      <div className="grid grid-cols-1 lg:grid-cols-[6fr_4fr] gap-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Parents */}
            <div className="relative rounded-4xl bg-[#EFB167] flex flex-col items-center sm:px-8 h-auto overflow-hidden">
            ...
            {/* Hospitals */}
            <div className="relative rounded-4xl bg-[#FFD29C] flex flex-col items-center sm:px-10 h-auto overflow-hidden">
              <div className="w-full py-6 px-4 sm:px-0">
                <h3 className="sub-head  relative z-10">
                  {useCases[1].title}
                </h3>
          ...
          {/* Row 2: Psychologists */}
          <div className="relative rounded-4xl bg-[#FEDAAF] flex flex-row justify-start p-6 sm:px-10  overflow-hidden">
        ...
        <div className="relative rounded-4xl bg-[#FFF0DE] p-6 sm:px-10 h-full overflow-hidden flex flex-col items-center justify-between">
          <div className="w-full">
            <h3 className="sub-head  relative z-10">
              {useCases[2].title}
            </h3>
