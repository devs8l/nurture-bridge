...
export default function Banner() {
  return (
    <div className="relative w-full sm:w-[85%] rounded-4xl my-10 flex flex-col justify-center h-[500px] overflow-hidden">
      {/* Background Video */}
      <video
      ...
      <div className="relative z-10  w-[50%] flex items-center h-full px-6 sm:px-8 md:px-12 lg:px-16">
        ...
        <div className="flex flex-col items-start gap-15">
          {/* Main Heading */}
          <h1 className="!text-white banner-head !text-left text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light leading-tight mb-8">
            Because early
            <br />
            action changes
            <br />
