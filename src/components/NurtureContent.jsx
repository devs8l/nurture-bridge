...
const NurtureContent = () => {
    return (
        <div className="w-full sm:w-[85%] py-10 mt-10">
            ...
            <div className="relative bg-white/80 rounded-xl p-8 md:p-25 flex flex-col  border border-[#524e4946] overflow-hidden group transition-all duration-300">
                
                {/* Main Heading */}
                <div className="text-center mb-8 md:mb-12">
                    <h2 className="heading-helius mb-6 md:mb-8 leading-tight">
                ...
                <div className="text-center max-w-4xl mx-auto">
                    <p className="content text-lg md:text-xl leading-relaxed text-gray-700">
